...
We reviewed relevant literature to define optimal environmental ranges for grape cultivation, focusing on elevation, temperature, slope, growing season conditions, and precipitation. Based on these findings, we set parameter thresholds with acceptable deviations.

DEM: JAXA/ALOS/AW3D30/V2_2 — ALOS DSM: Global 30m v3.2 Temperature: MODIS/006/MOD11A2 — MODIS Land Surface Temperature and Emissivity Slope: USGS/SRTMGL1_003 — NASA SRTM Digital Elevation 30m GST : TerraClimate dataset — IDAHO_EPSCOR/TERRACLIMATE GDD : TerraClimate dataset — IDAHO_EPSCOR/TERRACLIMATE GSP : TerraClimate dataset — IDAHO_EPSCOR/TERRACLIMATE Existing Vineyard: Exported from OpenStreetMap (OSM) Land Use: Land Cover Map 10m — UK Centre for Ecology & Hydrology
...
This project focuses on the United Kingdom from 2010 to 2023.\
Five environmental variables were selected based on literature thresholds:\
GST 14.1–15.5°C [@nesbitt2022climate],\
GDD 974–1223°C·days [@nesbitt2022climate;@bai2022viticultural],\
GSP 273–540mm [@nesbitt2022climate;@bai2022viticultural]),\
Slope 5–10% [@nesbitt2022climate;@nesbitt2018suitability;@bai2022viticultural],\
Elevation 0–220m [@unwin1991uk].\
